  ...
  return (
    <main className="min-h-dvh bg-stone-50 text-stone-900">
      <section className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="mt-14">
          <p className="text-xs font-semibold tracking-[0.18em] text-brand-navy uppercase">Request service</p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          <section className="rounded-md border border-stone-200 bg-white px-5 py-5">
            <h2 className="text-lg font-semibold text-stone-900">Selected service</h2>
            <dl className="mt-4 grid gap-3 text-sm text-stone-500">
              <div>
                <dt className="font-semibold text-stone-900">Pricing snapshot</dt>
          ...
          <section className="rounded-md border border-stone-200 bg-white px-5 py-5">
            <h2 className="text-lg font-semibold text-stone-900">Limited-scope acknowledgement</h2>
        ...
        <section className="mt-8 rounded-md border border-stone-200 bg-white px-5 py-5">
          <h2 className="text-lg font-semibold text-stone-900">Service inputs</h2>
          ...
          <ul className="mt-5 grid gap-3 text-sm leading-6 text-stone-500 md:grid-cols-2">
            {service.requiredInputs.map((input) => (
              <li key={input} className="rounded-md border border-stone-200 bg-stone-50 px-4 py-3">
                {input}
              </li>
            ))}
          </ul>
        ...
        <section className="mt-8 rounded-md border border-stone-200 bg-white px-5 py-5">
          <h2 className="text-lg font-semibold text-stone-900">Contract boundary</h2>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-stone-500">
          ...
          <button
            type="button"
            disabled
            className="mt-5 rounded-md bg-stone-200 px-4 py-2 text-sm font-semibold text-stone-400"
          >
